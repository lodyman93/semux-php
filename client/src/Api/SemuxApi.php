...
class SemuxApi
{
     ...
     *
     * @param  string $raw Raw transaction (required)
     *
     * @throws \Semux\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->broadcastRawTransactionWithHttpInfo($raw);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function broadcastRawTransactionAsync($raw)
    {
        return $this->broadcastRawTransactionAsyncWithHttpInfo($raw)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function broadcastRawTransactionRequest($raw)
    {
    ...
    {
        list($response) = $this->createAccountWithHttpInfo($name);
        return $response;
    }
     ...
     */
    public function createAccountWithHttpInfo($name = null)
    {
        $returnType = '\Semux\Client\Model\CreateAccountResponse';
        $request = $this->createAccountRequest($name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAccountAsync($name = null)
    {
        return $this->createAccountAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAccountAsyncWithHttpInfo($name = null)
    {
        $returnType = '\Semux\Client\Model\CreateAccountResponse';
        $request = $this->createAccountRequest($name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createAccountRequest($name = null)
    {
